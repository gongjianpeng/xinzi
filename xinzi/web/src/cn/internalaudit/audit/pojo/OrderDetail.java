...
public class OrderDetail  extends BaseEntity implements java.io.Serializable {
	...
	private String  ordershouName;
	private String  shoumobile;
	private String  shouzip;
	private String  shoutelephone;
	private String  shouordertime;
	private String  shoudeliveryTime;
	private String  shouaddress;
	private String  shoucompany;
	...
	public void setShoumobile(String shoumobile) {
		this.shoumobile = shoumobile;
	}

	public String getShouzip() {
		return shouzip;
	}

	public void setShouzip(String shouzip) {
		this.shouzip = shouzip;
	}

	public String getShoutelephone() {
		return shoutelephone;
	}

	public void setShoutelephone(String shoutelephone) {
		this.shoutelephone = shoutelephone;
	}

	public String getShouordertime() {
		return shouordertime;
	}

	public void setShouordertime(String shouordertime) {
		this.shouordertime = shouordertime;
	}

	public String getShoudeliveryTime() {
		return shoudeliveryTime;
	}

	public void setShoudeliveryTime(String shoudeliveryTime) {
		this.shoudeliveryTime = shoudeliveryTime;
	}
	...
	public void setShouremark(String shouremark) {
		this.shouremark = shouremark;
	}

	public String getOrdershouName() {
		return ordershouName;
	}

	public void setOrdershouName(String ordershouName) {
		this.ordershouName = ordershouName;
	}

	private String suojuName;
	private String suoxName;
	
	private String menlingName;
	
	private String maoyanName;
	
	private String xiadangName;
	
	private String lashouName;
	private String toujiaName;
	
	
	private String jiaolianName;
	private String bimenqiName;
	...
	public String getBimenqiName() {
		return bimenqiName;
	}

	public void setBimenqiName(String bimenqiName) {
		this.bimenqiName = bimenqiName;
	}
	...
	public String getSuojuName() {
		return suojuName;
	}

	public void setSuojuName(String suojuName) {
		this.suojuName = suojuName;
	}

	public String getSuoxName() {
		return suoxName;
	}

	public void setSuoxName(String suoxName) {
		this.suoxName = suoxName;
	}

	public String getMenlingName() {
		return menlingName;
	}

	public void setMenlingName(String menlingName) {
		this.menlingName = menlingName;
	}
	...
	public void setMaoyanName(String maoyanName) {
		this.maoyanName = maoyanName;
	}

	public String getXiadangName() {
		return xiadangName;
	}

	public void setXiadangName(String xiadangName) {
		this.xiadangName = xiadangName;
	}

	public String getLashouName() {
		return lashouName;
	}

	public void setLashouName(String lashouName) {
		this.lashouName = lashouName;
	}

	public String getToujiaName() {
		return toujiaName;
	}

	public void setToujiaName(String toujiaName) {
		this.toujiaName = toujiaName;
	}
