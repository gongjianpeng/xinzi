...
<table style="width: 100%;">
	<tr>
		...
		<td>
		尺寸：长 <input id="qType" style="width:50px;" > 宽：<input id="qType"  style="width:50px;"  >
		</td>
		</tr><tr>
		<td>
		樘数： <input id="qName" > </td>
		<td>
		门体高： <input id="qType" ></td>
		<td>
		墙体厚度： <input id="qType" >
		
		</td>
		<td> <input	id="query" type="button" value="<fmt:message key='datadictionary.search'/>" class="button09"></td>
...
<td>证件类型:</td>
	...
	<tr><td><span>001门面款式：</span>  <input id="country"  name="country"/>  </td><td> 名&nbsp;&nbsp;称：    <input id="province"  />   </td><td> 玻&nbsp;&nbsp;璃:<input id="boli"  /> </td></tr>
   	<tr><td>02子门面款式： <input id="zimen" > </td><td>名称款式： <input id="zimenlo" > </td><td>002子门面款式： <input id="zimenloend" > </td></tr>		
    <tr><td>003气窗款式： <input id="combo2" > </td></tr>		
    <tr><td>004边框样式：    门头 <input id="biank" > </td><td> 门柱： <input id="bianker" > </td><td> 门框： <input id="biankes" > </td></tr>	
     <tr><td>005色板样式： <input id="seban" > </td><td> 色板类型： <input id="sebaner" > </td><td> 色板类型样式： <input id="sebanerys" > </td></tr>	
      <tr><td>006 开向： <input id="kaixiang" > </td></tr>	
      <tr><td>007 板材： <input id="bancai" > </td><td> 门面厚度： <input id="banmenmian" > </td><td>门框厚度： <input id="banmenhou" > </td> </tr>		
      <tr><td>008 其他： <input id="qita" > </td> </tr>	
      <tr><td>009 11配件： <input id="peijian" > </td> </tr>	
...
<img id="logo" width="100" height="100" src="../../img/cardbg/card_bg01.png" /><br/>
<input id="uploadButton" type="button" value="设置Logo"/>

                                                    <select id="select_bg" style="width: 227px">
                                                        <option selected="" value='${card.cardbg }'>请选择会员卡背景图</option>
                                                        <option value="../../img/cardbg/card_bg01.png">01 </option>
                                                        <option value="../../img/cardbg/card_bg02.png">02</option>
                                                        <option value="../../img/cardbg/card_bg03.png">03</option>
                                                        <option value="../../img/cardbg/card_bg04.png">04</option>
                                                        <option value="../../img/cardbg/card_bg05.png">05</option>
                                                        <option value="../../img/cardbg/card_bg06.png">06</option>
                                                        <option value="../../img/cardbg/card_bg07.png">07</option>
                                                        <option value="../../img/cardbg/card_bg08.png">08</option>
                                                        <option value="../../img/cardbg/card_bg09.png">09</option>
                                                        <option value="../../img/cardbg/card_bg10.png">10</option>
                                                        <option value="../../img/cardbg/card_bg11.png">11</option>
                                                        <option value="../../img/cardbg/card_bg12.png">12</option>
                                                        <option value="../../img/cardbg/card_bg13.png">13</option>
                                                        <option value="../../img/cardbg/card_bg14.png">14</option>
                                                        <option value="../../img/cardbg/card_bg15.png">15</option>
                                                        <option value="../../img/cardbg/card_bg16.png">16</option>
                                                        <option value="../../img/cardbg/card_bg17.png">17</option>
                                                        <option value="../../img/cardbg/card_bg18.png">18</option>
                                                        <option value="../../img/cardbg/card_bg19.png">19</option>
                                                        <option value="../../img/cardbg/card_bg20.png">20</option>
                                                        <option value="../../img/cardbg/card_bg21.png">21</option>
                                                        <option value="../../img/cardbg/card_bg22.png">22</option>
                                                        <option value="../../img/cardbg/card_bg23.png">23</option>
                                                    </select>
                                                </div>
