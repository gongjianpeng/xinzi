            ...
            $('#dataDictionaryTable').omGrid({
             title : '色板数据列表'+
                ...
                colModel : [ 
                              ...
                              {header : "色板名称", name : 'name', align : 'left' },
                              {header : "色板描述", name : 'contents', align : 'left'},
                              {header : "色板别称", name : 'sname', align : 'left'},
            ...
            ***/
            ...
            function showResponse(data){
            	if(data!=null&&data=="true"){
			 		...
			 		$('#operation').val("");
				 	$('#dataDictionaryTable').omGrid('setData','getDataPalettes.do');
            ...
            $('#delete').die().live('click', function(e) {
                ...
                $.omMessageBox.confirm({
                   ...
                   onClose:function(value){
		                ...
		                $.post('PaletteOperate.do',{operation:'delete',id:toDeleteRecordID},function(){
             ...
             $('#query').bind('click', function(e) {
                ...
                if(qCode==""&&qName===""&&qType==""){ //No query criteria to, to display all data
                    $('#dataDictionaryTable').omGrid("setData", 'PaletteOperate.do');
                }else{ //Query, display the query data
                    $('#dataDictionaryTable').omGrid("setData", 'PaletteOperate.do?qName='+encodeURI(qName)+'&qType='+encodeURI(qType));
                }
...
<div id="dialog-form">
<form id="ipForm" action="PaletteOperate.do" method="post"><input name="operation"
