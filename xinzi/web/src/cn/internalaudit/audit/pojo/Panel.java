...
/**
 * Panel entity. 板材  bancai
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "panel", catalog = "xinzi")
public class Panel  extends  BaseEntity  implements java.io.Serializable {
	...
	/** full constructor */
	public Panel(String name, String contents, String sname, String type,
