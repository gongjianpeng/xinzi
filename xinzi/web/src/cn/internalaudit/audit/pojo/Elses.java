 ...
 */
@Entity
@Table(name = "Elses", catalog = "xinzi")
public class Elses  extends  BaseEntity implements java.io.Serializable {
	...
	/** full constructor */
	public Elses(String name, String contents, String sname, String type,
