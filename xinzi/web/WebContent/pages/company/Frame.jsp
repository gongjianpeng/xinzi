        ...
        $(document).ready(function() {
            ...
            $('#dataDictionaryTable').omGrid({
             title : '边框样式列表'+
                ...
                showIndex : false,
                colModel : [ 
                              {header : "边框名称", name : 'name', align : 'left' },
                              {header : "边框描述", name : 'contents', align : 'left'},
                              {header : "边框别称", name : 'sname', align : 'left'},
                              {header : "备注", name : 'remark', align : 'left'},
                              {header : "备注字段", name : 'field', align : 'left'}
            ...
            ***/
            ...
            function showResponse(data){
            	if(data!=null&&data=="true"){
			 		...
			 		$('#operation').val("");
				 	$('#dataDictionaryTable').omGrid('setData','getDataFrames.do');
            ...
            $('#delete').die().live('click', function(e) {
                ...
                $.omMessageBox.confirm({
                   ...
                   onClose:function(value){
		                ...
		                $.post('frameOperate.do',{operation:'delete',id:toDeleteRecordID},function(){
             ...
             $('#query').bind('click', function(e) {
                ...
                if(qCode==""&&qName===""&&qType==""){ //No query criteria to, to display all data
                    $('#dataDictionaryTable').omGrid("setData", 'frameOperate.do');
                }else{ //Query, display the query data
                    $('#dataDictionaryTable').omGrid("setData", 'frameOperate.do?qName='+encodeURI(qName)+'&qType='+encodeURI(qType));
                }
...
<div id="dialog-form">
<form id="ipForm" action="frameOperate.do" method="post"><input name="operation"
