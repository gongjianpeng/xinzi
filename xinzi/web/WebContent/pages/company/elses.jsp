            ...
            $('#dataDictionaryTable').omGrid({
             title : '其他列表'+
                ...
                colModel : [ 
                              ...
                              {header : "其他名称", name : 'name', align : 'left' },
                              {header : "描述", name : 'contents', align : 'left'},
                              {header : "款式", name : 'sname', align : 'left'},
            ...
            ***/
            ...
            function showResponse(data){
            	if(data!=null&&data=="true"){
			 		...
			 		$('#operation').val("");
				 	$('#dataDictionaryTable').omGrid('setData','getDataElses.do');
            ...
            $('#delete').die().live('click', function(e) {
                ...
                $.omMessageBox.confirm({
                   ...
                   onClose:function(value){
		                ...
		                $.post('elsesOperate.do',{operation:'delete',id:toDeleteRecordID},function(){
             ...
             $('#query').bind('click', function(e) {
                ...
                if(qCode==""&&qName===""&&qType==""){ //No query criteria to, to display all data
                    $('#dataDictionaryTable').omGrid("setData", 'elsesOperate.do');
                }else{ //Query, display the query data
                    $('#dataDictionaryTable').omGrid("setData", 'elsesOperate.do?qName='+encodeURI(qName)+'&qType='+encodeURI(qType));
                }
...
<div id="dialog-form">
<form id="ipForm" action="elsesOperate.do" method="post"><input name="operation"
