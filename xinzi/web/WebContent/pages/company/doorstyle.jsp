            ...
            $('#dataDictionaryTable').omGrid({
             title : '门面列表'+
                ...
                colModel : [ 
                              ...
                              {header : "门面名称", name : 'name', align : 'left' },
                              {header : "门面描述", name : 'contents', align : 'left'},
                              {header : "门面别称", name : 'sname', align : 'left'},
            ...
            ***/
            ...
            function showResponse(data){
            	if(data!=null&&data=="true"){
			 		...
			 		$('#operation').val("");
				 	$('#dataDictionaryTable').omGrid('setData','getDataDoorstyles.do');
            ...
            $('#delete').die().live('click', function(e) {
                ...
                $.omMessageBox.confirm({
                   ...
                   onClose:function(value){
		                ...
		                $.post('doorstyleOperate.do',{operation:'delete',id:toDeleteRecordID},function(){
...
<div id="dialog-form">
<form id="ipForm" action="doorstyleOperate.do" method="post"><input name="operation"
