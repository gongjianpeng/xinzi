        ...
        $(document).ready(function() {
            ...
            $('#dataDictionaryTable').omGrid({
             title : '配件数据列表'+
                ...
                showIndex : false,
                colModel : [ 
                              {header : "配件名称", name : 'name', align : 'left' },
                              {header : "配件描述", name : 'contents', align : 'left'},
                              {header : "配件别称", name : 'sname', align : 'left'},
            ...
            ***/
            ...
            function showResponse(data){
            	if(data!=null&&data=="true"){
			 		...
			 		$('#operation').val("");
				 	$('#dataDictionaryTable').omGrid('setData','getDataAccesss.do');
            ...
            $('#delete').die().live('click', function(e) {
                ...
                $.omMessageBox.confirm({
                   ...
                   onClose:function(value){
		                ...
		                $.post('AccessOperate.do',{operation:'delete',id:toDeleteRecordID},function(){
             ...
             $('#query').bind('click', function(e) {
                ...
                if(qCode==""&&qName===""&&qType==""){ //No query criteria to, to display all data
                    $('#dataDictionaryTable').omGrid("setData", 'AccessOperate.do');
                }else{ //Query, display the query data
                    $('#dataDictionaryTable').omGrid("setData", 'AccessOperate.do?qName='+encodeURI(qName)+'&qType='+encodeURI(qType));
                }
...
<div id="dialog-form">
<form id="ipForm" action="AccessOperate.do" method="post"><input name="operation"
