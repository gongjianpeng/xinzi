	...
	$('#myTree').omTree(
		{
			...
			onSelect : function(nodedata) {
				 ...
				 if(nodedata.isHeadquarters != null){
					 $('#mytable').omGrid('setData','getOrganizationByTreeId.do?id=' + nodedata.id);
					 $('#deptTable').omGrid('setData','getDepartmentsByOrg.do?orgId=' + nodedata.id);
					 ...
					 $('#mytable').omGrid('setData','getOrganizationByTreeId.do');
					 $('#deptTable').omGrid('setData','getDepartmentsByOrg.do?deptId=' + nodedata.id);
					 ...
					 $('#mytable').omGrid('setData','getOrganizationByTreeId.do');
					 $('#deptTable').omGrid('setData','getDepartmentsByOrg.do');
					 $('#menu').omMenu('disableItem','001').omMenu('disableItem','002').omMenu('disableItem','003')
			...
			dataSource : "getOrganizationTree.do"
						...
						success : function(responseText) {
						            if(responseText=="true"){
										...
										$("#dialog-dept").omDialog("close");
										 $('#myTree').omTree('setData','getOrganizationTree.do').omTree('refresh');
