...
alert($(document.body).outerWidth(true));//浏览器时下窗口文档body的总宽度 包括border padding margin 
        ...
        show: function() {
            ...
            //check body height and display canlendar bar height for page body
        	var e =window.event;
        	  var bodyheight=document.body.scrollHeight;
        	  var y=e.clientY;
        	//  var q=document.body.outerHeight(true);
        	//  var d2=document.body.scrollTop;
        	//  var d3=document.documentElement.scrollTop;
            ...
            * */
        	   // alert("d"+d+"q"+q);
        	//    alert("body.height="+bodyheight+"z"+z);
            //} 
        	    if(z>bodyheight){
