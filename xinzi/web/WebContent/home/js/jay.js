...
$(document).ready(function() {
	...
	var docmH = $(document).height();
		$(".dialog-boxs").height(docmH);		
	var dialog = buildFuc('.pop_box, .dialog-boxs');
	dialog('.inputClick' , '#box,.dialog-boxs' ,  '.pop_box .imgClose' );	
	$('#box,.dialog-boxs').show();
});
