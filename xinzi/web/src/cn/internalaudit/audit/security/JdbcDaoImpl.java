...
public class JdbcDaoImpl extends JdbcDaoSupport implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException, DataAccessException {
        ...
        Date lastDate;
//		try {
//			lastDate = Utils.dateFormat.parse("2013-4-30");
//			if(date.compareTo(lastDate) > 0){
//				throw new UsernameNotFoundException(
//	                    messages.getMessage("JdbcDaoImpl.notFound", new Object[]{username}, "User {0} use of authorit has expired!"), username);
//	        }
...
//		}
    ...
    protected List<GrantedAuthority> loadUserAuthorities(String username) {
        return getJdbcTemplate().query(authoritiesByUsernameQuery, new String[] {username,username}, new RowMapper<GrantedAuthority>() {
