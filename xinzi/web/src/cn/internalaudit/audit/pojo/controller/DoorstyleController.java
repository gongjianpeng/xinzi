 ...
 */
@Controller
public class DoorstyleController {

	public static final String ADD = "add";
	public static final String UPDATE = "update";
	public static final String DELETE = "delete";

	@Resource(name = "DoorstyleBo")
	public IDoorstyleBo doorstyleBo;
	...
	@RequestMapping(value = "/pages/company/doorstyleOperate.do")
	public String DoorstyleOperate(Locale locale, Model model,
			HttpServletRequest request, HttpServletResponse response,
			Doorstyle entity) throws Exception {
		...
		if (ADD.equals(operation)) {
			entity.setOrg(orgid);
			doorstyleBo.save(entity);
			writer.write("true");
		} else if (UPDATE.equals(operation)) {
			doorstyleBo.update(entity);
			writer.write("true");
		} else if (DELETE.equals(operation)) {
			doorstyleBo.delete(entity);
			writer.write("true");
		}
		writer.flush();
		return null;
	...
	@RequestMapping(value = "/pages/company/getDataDoorstyles.do")
	public String getDataDoorstyles(Locale locale, Model model,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		response.setContentType("text/html;charset=UTF-8");
		response.setHeader("Cache-Control", "no-cache");
		...
		int end = start + limit;
		List<Doorstyle> entitys = new ArrayList<Doorstyle>();
		
		
		entitys = doorstyleBo.findByParms(map);
