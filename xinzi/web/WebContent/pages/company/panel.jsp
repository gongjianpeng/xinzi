            ...
            $('#dataDictionaryTable').omGrid({
             title : '板材数据列表'+
                ...
                colModel : [ 
                              ...
                              {header : "板材名称", name : 'name', align : 'left' },
                              {header : "描述", name : 'contents', align : 'left'},
                              {header : "板材别称", name : 'sname', align : 'left'},
            ...
            ***/
            ...
            function showResponse(data){
            	if(data!=null&&data=="true"){
			 		...
			 		$('#operation').val("");
				 	$('#dataDictionaryTable').omGrid('setData','getDataPanels.do');
            ...
            $('#delete').die().live('click', function(e) {
                ...
                $.omMessageBox.confirm({
                   ...
                   onClose:function(value){
		                ...
		                $.post('panelOperate.do',{operation:'delete',id:toDeleteRecordID},function(){
...
<div id="dialog-form">
<form id="ipForm" action="panelOperate.do" method="post"><input name="operation"
...
<table> 
	...
	<tr> 
		...
		</tr></table><div align="center"><input type="hidden" id="org" name="org"></div><table><tr> 
	</tr> 
